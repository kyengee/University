...
import static com.example.jk321.myapplication.treemap.dot;
...
public class GpsInfo extends Service implements LocationListener {
    ...
    public void onLocationChanged(Location location) {
        ...
        if(location != null) {
            lat = location.getLatitude();
            lon = location.getLongitude();
            dot.changeLocation(lat,lon);
            Toast.makeText(mContext, "onLocationChanged is - \nLat: " + lat + "\nLong: " + lon, Toast.LENGTH_SHORT).show();
            //sendBroadcast(new Intent().setAction("Location").putExtra("getLocation",location));
