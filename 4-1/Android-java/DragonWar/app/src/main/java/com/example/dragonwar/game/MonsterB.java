...
public class MonsterB extends Monster{
    ...
    public MonsterB() {
        super(AppManager.getInstance().getBitmap(R.drawable.monster_red));
        mFrameTimer = 0;
        hp =10;
        speed = 10f;

        movetype = Monster.MOVE_PATTERN_2;
    }
    ...
    public void Update(long GameTime) {
        ...
        if(GameTime > mFrameTimer + 2000){
            ...
            m_Alist.add(new Missile_Monster(AppManager.getInstance().getBitmap(R.drawable.monster_attack_red), m_x - 350, m_y + 135, 15, 0));
        }
