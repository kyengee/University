...
public class BossB extends Monster{
    ...
    public void Update(long GameTime) {
        ...
        if (m_y < 0)
            ...
            if(random.nextInt(2) == 1)
                ...
                speed = -3f;
            m_Alist.add(new Missile_Monster(AppManager.getInstance().getBitmap(R.drawable.monster_attack_purple), m_x, m_y, 15, 0));
    ...
    public BossB() {
        super(AppManager.getInstance().getBitmap(R.drawable.boss_purple));
        hp =20;
        speed = 3f;
        mFrameTimer = 0;
