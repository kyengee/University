...
public class GameState2 extends GameState implements IState {

    private static GameState2 s_instance;

    public static GameState getInstance(){
        return s_instance;
    }
    // 멤버 변수 추가할 곳
    private background3 m_background;
    ...
    public void Init() {
        s_instance = this;
        m_background = new background3();
        m_player = new player_red();
        Monster enem = new BossC();
