...
def error(x_i, y_i, beta):
    global predict_values
    predict_values.append(predict(x_i, beta))
...
if __name__ == "__main__":
    ...
    df['predict_value'] = pandas.Series(predict_values, index = df.index)
    print (df['predict_value'])
    df.to_csv("microtech.csv", index=False, encoding='ms949')
    '''