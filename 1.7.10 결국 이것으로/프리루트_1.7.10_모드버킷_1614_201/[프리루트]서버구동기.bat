@echo off
title 마인크래프트 1.7.10 K콜드론 모드버킷 with 프리루트
:main
cls
echo.
echo ┍──────────────────────────────
echo │
echo │     프리루트의 마인크래프트 1.7.10 K콜드론 모드버킷
echo │
echo │
...
echo │
echo │
echo │  * 핵심파일 제작 : Sergey Shatunov 외에 6명 / 구동기 제작 : 프리루트
echo │  * 핵심파일 버전 : 1.7.10_1614-201
echo │  * 탑재된 포지 버전 : 10.13.4.1614
echo │  * 제작날짜 : 2017.04.05
echo │
echo ┕──────────────────────────────
...
java -Xms512M -Xmx512M -jar [KCauldron]1.7.10_1614-201_Core.jar
PAUSE
goto main
...
java -Xms1G -Xmx1G -jar [KCauldron]1.7.10_1614-201_Core.jar
PAUSE
goto main
...
java -Xms1G -Xmx2G -jar [KCauldron]1.7.10_1614-201_Core.jar
PAUSE
goto main
...
java -Xms1G -Xmx4G -jar [KCauldron]1.7.10_1614-201_Core.jar
PAUSE
goto main
...
java -Xms1G -Xmx8G -jar [KCauldron]1.7.10_1614-201_Core.jar
PAUSE
goto main
...
java -Xms1G -Xmx16G -jar [KCauldron]1.7.10_1614-201_Core.jar
PAUSE
goto main
