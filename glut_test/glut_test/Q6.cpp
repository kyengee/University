...
GLvoid drawScene(GLvoid)
{
	...
	for (int i = 0; i < DotLength; i++) {
		...
		if (DotList[i].type == 1) {
			if (DotList[i].x - size <= 0) {
				DotList[i].Xspeed = 0;
				DotList[i].Yspeed = -5;
			}
			if (DotList[i].x + size >= 800) {
				DotList[i].Xspeed = 0;
				DotList[i].Yspeed = 5;
			}
			if (DotList[i].y - size - 5 <= 0) {
				DotList[i].Xspeed = 5;
				DotList[i].Yspeed = 0;
			}
			if (DotList[i].y == DotList[i].lastY && DotList[i].Yspeed == 5) {
				DotList[i].Xspeed = -5;
				DotList[i].Yspeed = 0;
			}

			if (DotList[i].y == DotList[i].lastY && DotList[i].x == DotList[i].lastX) {
